...
// Fix: Add `LiveClientEventTypes` as a generic to `EventEmitter` to make `emit` available.
// Fix: Added LiveClientEventTypes as a generic to EventEmitter to fix 'emit' property error.
